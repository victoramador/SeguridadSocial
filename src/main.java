...
class Main {
    public static void main(String[] args) {
        ...
        System.out.println("obtenerSalarioMinimo: "+ seguridadSocial.obtenerPersonaPorSalarioMinimo());

        System.out.println("obtenerSalarioMaximo: "+ seguridadSocial.obtenerPersonaPorSalarioMaximo());
